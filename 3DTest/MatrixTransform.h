...
namespace Matrix {
	...
	inline const Mat4 Orthographic(float width, float height, float near, float far) {
		return Mat4(
			Vector4F(2.f / width,	0.f,			0.f,							0.f),
			Vector4F(0.f,			2.f / height,	0.f,							0.f),
			Vector4F(0.f,			0.f,			2.f / (far - near),				0.f),
			Vector4F(-1.f,			-1.f,			(-far - near) / (far - near),	1.f)
		);
	}
